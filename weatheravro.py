...
weatherschema = AvroSchema(weather)
print("Schema info is: " + weatherschema.schema_info().schema())

producer = client.create_producer(topic='persistent://public/default/pi-weather-avro' ,schema=weatherschema,properties={"producer-name": "weatheravro-py-sensor","producer-id": "weather-avro-sensor" })
